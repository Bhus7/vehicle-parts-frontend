...
const CustomerLayout = () => {
    ...
    <>
      ...
      <div className="p-6 border-b border-slate-800 flex items-center justify-between">
        ...
        <button 
          ...
          className="lg:hidden p-2 text-slate-500 hover:text-white hover:bg-slate-800 rounded-lg"
        >
          <X size={18} />
        </button>
      </div>
  ...
  return (
    <div className="flex min-h-screen bg-slate-950 font-sans text-slate-200">
      ...
      {/* ── Desktop Sidebar ─────────────────────────────────────────────── */}
      <aside className="hidden lg:flex w-64 shrink-0 bg-slate-900 border-r border-slate-800 flex flex-col h-screen sticky top-0 z-40">
      ...
      <aside className={`fixed top-0 bottom-0 left-0 z-50 w-64 bg-slate-900 border-r border-slate-800 flex flex-col h-screen transition-transform duration-300 transform lg:hidden ${
      ...
      <main className="flex-1 flex flex-col min-h-screen w-full overflow-x-hidden">
        {/* Top Bar */}
        <header className="h-16 bg-slate-900 border-b border-slate-800 px-4 md:px-8 flex items-center justify-between sticky top-0 z-30">
