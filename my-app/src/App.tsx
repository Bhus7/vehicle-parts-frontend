    ...
    <div className="flex min-h-screen bg-[#f8fafc] font-sans text-slate-800 selection:bg-indigo-500/10">
      ...
      <aside className="w-72 shrink-0 bg-white border-r border-slate-200/80 flex flex-col h-screen sticky top-0 z-40 overflow-hidden">
        ...
        <nav className="flex-1 px-4 py-4 space-y-1.5 overflow-y-auto">
          ...
          <Link
            to="/staff"
            className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${isActive('/staff')
          ...
          <Link
            to="/staff/register"
            className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${isActive('/staff/register')
              ? 'bg-indigo-50 text-indigo-600 font-semibold border-l-4 border-indigo-600 rounded-l-none'
              : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50'
              }`}
          >
          ...
          <Link
            to="/staff/sales"
            className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${isActive('/staff/sales')
              ? 'bg-indigo-50 text-indigo-600 font-semibold border-l-4 border-indigo-600 rounded-l-none'
              : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50'
              }`}
          >
          ...
          <Link
            to="/staff/search"
            className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${isActive('/staff/search')
              ? 'bg-indigo-50 text-indigo-600 font-semibold border-l-4 border-indigo-600 rounded-l-none'
              : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50'
              }`}
          >
          ...
          <Link
            to="/staff/reports"
            className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${isActive('/staff/reports')
              ? 'bg-indigo-50 text-indigo-600 font-semibold border-l-4 border-indigo-600 rounded-l-none'
              : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50'
              }`}
          >
